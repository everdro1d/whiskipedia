...
public class MainWorker {
    ...
    private static final Map<String, String> CUSTOM_ALIASES_MAP = Map.of(
            "-d", "--debug",
            "-gd", "--gui-debug"
    );
    public static CommandManager commandManager = new CommandManager(CUSTOM_COMMANDS_MAP, CUSTOM_ALIASES_MAP);
